...
class KriteriaModel extends Model
{
    ...
    protected $column_order = [null, 'kode_kriteria', 'judul_kriteria', 'sifat', null];
    protected $column_search = ['kode_kriteria', 'judul_kriteria', 'sifat'];
    protected $order = ['kode_kriteria' => 'DESC'];
    protected $db;
    protected $dt;
